...
// ============================================================================
// Génération de personnages pour la simulation
// ============================================================================
...
export const genLevelBoosts = (level) => {
...
export const getPassiveLevelForCharacterLevel = (level) => {
  if (level >= 100) return 3;
  if (level >= 50) return 2;
  return 1;
};

export const makeCharacter = (id, level, availableWeaponIds, availablePassiveIds) => {
...
export const makeCustomCharacter = (id, raceName, className, level, weaponId, passiveId, passiveLevel) => {
  const raw = genStats();
  const raceBonus = getRaceBonus(raceName);
  const classBonus = getClassBonus(className);
  const levelBoosts = genLevelBoosts(level);
