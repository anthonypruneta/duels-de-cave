  ...
  return (
    <div className="min-h-screen p-6">
      ...
      <div className="max-w-[1800px] mx-auto pt-16">
        ...
        <CombatLayout
          p1Entity={{ name: playerCharacter?.name, currentHP: replayP1HP || (playerCharacter?.currentHP ?? playerCharacter?.base?.hp), maxHP: replayP1MaxHP || (playerCharacter?.maxHP ?? playerCharacter?.base?.hp), shield: replayP1Shield ?? 0, base: replayP1Base ?? playerCharacter?.base ?? {} }}
          p2Entity={{ name: enemyCharacter?.name, currentHP: replayP2HP || (enemyCharacter?.currentHP ?? enemyCharacter?.base?.hp), maxHP: replayP2MaxHP || (enemyCharacter?.maxHP ?? enemyCharacter?.base?.hp), shield: replayP2Shield ?? 0, base: replayP2Base ?? enemyCharacter?.base ?? {} }}
