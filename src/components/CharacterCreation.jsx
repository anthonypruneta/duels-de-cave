...
const CharacterCreation = () => {
  ...
  const classes = {
    ...
    'Voleur': { ability: 'Esquive (CD: 2 tours)', description: '+5 VIT | Esquive 1 coup | +10% crit/palier 15Cap | Crit x2', icon: '🌀' },
    'Paladin': { ability: 'Riposte (Chaque tour)', description: 'Renvoie 70% +12%/15Cap des dégâts reçus', icon: '🛡️' },
    'Healer': { ability: 'Soin puissant (CD: 2 tours)', description: '+3 Auto | Heal 20% PV manquants + (25% +5%/15Cap) × Capacité', icon: '✚' },
