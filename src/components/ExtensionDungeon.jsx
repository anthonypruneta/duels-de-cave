...
const ExtensionDungeon = () => {
  ...
  const PlayerCard = ({ char }) => {
    ...
    const extensionDetails = getPassiveDetails(char.mageTowerExtensionPassive);
      ...
      <div className="relative shadow-2xl overflow-visible">
        ...
        <div className="overflow-visible">
          ...
          <div className="bg-stone-800 p-4 border-t border-stone-600">
            ...
            {extensionDetails && (
              <div className="flex items-start gap-2 bg-stone-700/50 p-2 text-xs border border-violet-600/50">
                <span className="text-lg">{extensionDetails.icon}</span>
                <div className="flex-1">
                  <div className="text-violet-300 font-semibold mb-1">
                    {extensionDetails.name} — Niveau {extensionDetails.level} (Extension)
                  </div>
                  <div className="text-stone-400 text-[10px]">{extensionDetails.levelData.description}</div>
                </div>
              </div>
            )}
            {isAwakeningActive && (
              <div className="flex items-start gap-2 bg-stone-700/50 p-2 text-xs border border-stone-600">
                ...
                <div className="flex-1">
                  <div className="text-amber-300 font-semibold mb-1">Éveil racial actif</div>
