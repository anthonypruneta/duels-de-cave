...
export const SUBCLASSES_BY_CLASS = {
  ...
  'Succube': [
    ...
    { id: 'ame_tentatrice', name: 'Ame Tentatrice', bonus: '+15% chance de critique', abilityLabel: 'Coup de Fouet (CD: 4 tours)', description: 'Inflige Auto + 60% CAP. La prochaine attaque adverse inflige -60% dégâts. Cette capacité crit obligatoirement.' },
  ],
  'Bastion': [
  ...
  'Berserk': [
    { id: 'boucher', name: 'Boucher', bonus: '+20% HP', abilityLabel: 'Rage (CD: 4 tours)', description: 'Consomme 10% PV max (ne peut pas mourir). Inflige Auto + 35% des PV manquants (après le coût). +0,1% par point de Cap sur ce pourcentage.' },
    { id: 'brise_caves', name: 'Brise-Caves', bonus: '+10% Auto', abilityLabel: 'Rage (CD: 4 tours)', description: 'Consomme 10% PV max (ne peut pas mourir). Inflige Auto + 25% des PV manquants (après le coût). +0,1% par point de Cap sur ce pourcentage. La prochaine auto inflige +20% de dégâts.' },
  ],
};
