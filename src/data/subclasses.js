...
export const SUBCLASSES_BY_CLASS = {
  ...
  'Masochiste': [
    { id: 'flagellant_sanglant', name: 'Flagellant Sanglant', bonus: '+10% Cap', abilityLabel: 'Purge sanglante (CD: 4 tours)', description: 'Renvoie 6% dégâts accumulés + 0,5% Cap. Soigne 10% des dégâts accumulés. Réduit votre DEF de 20% mais augmente votre Auto de 12% pour le reste du combat.' },
    { id: 'ecorche_fer', name: 'Ecorché de Fer', bonus: '+7% HP', abilityLabel: 'Purge sanglante (CD: 4 tours)', description: 'Renvoie 6% dégâts accumulés + 0,5% Cap. Soigne 10% des dégâts accumulés. Chaque Purge augmente votre DEF et ResC de 3%.' },
  ],
  'Succube': [
    ...
    { id: 'ame_tentatrice', name: 'Ame Tentatrice', bonus: '+10% chance de critique', abilityLabel: 'Coup de Fouet (CD: 4 tours)', description: 'Inflige Auto + 45% CAP. La prochaine attaque adverse inflige -50% dégâts. Cette capacité crit une fois sur deux (si le précédent n\'a pas crit, le prochain crit obligatoire).' },
  ],
  'Bastion': [
  ...
  'Healer': [
    { id: 'luxum', name: 'Luxum', bonus: '+10% CAP', abilityLabel: 'Soin puissant (CD: 4 tours)', description: 'Soigne 28% des PV manquants + 43% Cap. À chaque lancement : gain d\'un bouclier égal à 25% de votre CAP. Convertit l\'overheal en bouclier.' },
    { id: 'latum', name: 'Latum', bonus: '+8% Auto', abilityLabel: 'Soin puissant (CD: 4 tours)', description: 'Inflige 15% des PV manquants en dégâts à l\'ennemi, puis soigne 28% des PV manquants + 43% Cap.' },
  ],
  'Alchimiste': [
  ...
  'Berserk': [
    { id: 'boucher', name: 'Boucher', bonus: '+20% HP', abilityLabel: 'Rage (CD: 4 tours)', description: 'Consomme 10% PV max (ne peut pas mourir). Inflige Auto + 50% des PV manquants (après le coût).' },
