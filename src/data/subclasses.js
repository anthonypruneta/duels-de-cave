...
export const SUBCLASSES_BY_CLASS = {
  ...
  'Bastion': [
    { id: 'rempart_fer', name: 'Rempart de Fer', bonus: '+12% DEF', abilityLabel: 'Charge du Rempart (CD: 4 tours)', description: 'Début du combat : bouclier = 45% DEF. Inflige Auto + 50% CAP + 50% DEF.' },
