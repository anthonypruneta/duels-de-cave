...
const CAVE_DESTINY_EVENTS_CORE = [
  {
    ...
    options: [
      ...
      },
      {
        ...
        ifRace: ['Orc', 'Cendrés'],
        outcomes: trio(
          { text: 'Blessé, vous devenez terrifiant. L’adversaire cède.', deltas: { puissance: 6, renommee: 6, forme: -4 } },
          { text: 'La rage aide… sans tout décider.', deltas: { puissance: 2, forme: -5 } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'L’explosion clôt le duel. Les gradins retiennent leur souffle.', deltas: { magie: 7, renommee: 8, trophies: { tournoi: 1 } } },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'Vous l’affrontez et gagnez sa faveur mystique.', deltas: { magie: 5, renommee: 4, or: 6 } },
          { text: 'Vous l’apercevez… puis elle disparaît.', deltas: { magie: 2, moral: 1 } },
      ...
      },
      {
        ...
        ifRace: ['Sylvari'],
        outcomes: trio(
          { text: 'La forêt vous reconnaît. Régénération et butin.', deltas: { endurance: 5, forme: 6, or: 4 } },
          { text: 'Les racines vous soutiennent… un peu.', deltas: { forme: 2, endurance: 1 } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'Vos flèches dansent entre les arbres. La clairière est à vous.', deltas: { vitesse: 6, or: 7, renommee: 3 } },
          { text: 'Vous harcelez bien, quelques flèches perdues.', deltas: { vitesse: 2, forme: -3 } },
          { text: 'Vous vous coinces contre un chêne. La faune en profite.', deltas: { forme: -9, vitesse: -1, moral: -4 } },
        ),
      },
    ],
  },
    ...
    options: [
      {
        ...
        outcomes: trio(
          { text: 'Étage conquis. Un passif rare s’ancre en vous.', deltas: { magie: 7, renommee: 5, forme: -5, trophies: { tour: 1 } } },
          { text: 'Vous passez… avec très peu de PV.', deltas: { magie: 3, forme: -8 } },
          { text: 'Le gardien vous renvoie au hall d’entrée.', deltas: { forme: -11, moral: -6, magie: 1 } },
        ),
      },
      {
        id: 'passif',
        ...
        outcomes: trio(
          { text: 'Synergie parfaite. Votre aura change.', deltas: { magie: 5, vitesse: 2, moral: 3 } },
          { text: 'Passif correct, rien d’éclatant.', deltas: { magie: 2 } },
          { text: 'Mauvais choix. L’étage suivant le prouve.', deltas: { moral: -5, magie: -1, renommee: -2 } },
        ),
      },
      {
        id: 'liche',
        ...
        outcomes: trio(
          { text: 'La barrière macabre cède. Vous grimpez.', deltas: { magie: 6, renommee: 4, or: 5 } },
          { text: 'Vous survolez la galerie d’os.', deltas: { magie: 2, forme: -4 } },
      ...
      },
      {
        ...
        ifRace: ['Mindflayer'],
        outcomes: trio(
          { text: 'Vous renvoyez le sort volé. Le gardien vacille.', deltas: { magie: 8, renommee: 4 } },
          { text: 'Le sort copié est… moyen. Suffisant.', deltas: { magie: 3 } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'Vos soins portent l’assaut. L’étage tombe.', deltas: { magie: 5, charisme: 4, or: 5 } },
          { text: 'Vous maintenez le rythme.', deltas: { magie: 2, forme: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'L’égide tient. Les coups d’Ornn rebondissent.', deltas: { endurance: 6, renommee: 4, forme: -4 } },
          { text: 'Bouclier correct, progression lente.', deltas: { endurance: 2, forme: -5 } },
    ...
    options: [
      {
        ...
        outcomes: trio(
          { text: 'Nouveau record. Votre nom monte au classement hebdomadaire.', deltas: { vitesse: 5, renommee: 8, forme: -7, trophies: { labyrinthe: 1 } } },
          { text: 'Palier correct. Rien d’historique.', deltas: { vitesse: 2, forme: -5, or: 2 } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'Votre carte ment moins que les murs. Avantage.', deltas: { magie: 3, vitesse: 3, renommee: 2 } },
      ...
      },
      {
        ...
        ifRace: ['Elfe', 'Gnome'],
        outcomes: trio(
          { text: 'Les critiques s’enchaînent. Le couloir s’ouvre.', deltas: { vitesse: 4, puissance: 4, renommee: 3 } },
          { text: 'Quelques critiques décisifs.', deltas: { vitesse: 2 } },
    ...
    options: [
      {
        ...
        outcomes: trio(
          { text: 'Vous brisez le miroir. Quelque chose se décante en vous.', deltas: { puissance: 4, magie: 3, moral: 6, renommee: 4 } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'Vous anticipez chaque geste. Victoire nette.', deltas: { magie: 4, vitesse: 3, renommee: 3 } },
          { text: 'Vous voyez deux ouvertures. Une suffit.', deltas: { magie: 2 } },
      ...
      },
      {
        ...
        ifRace: ['Mort-vivant'],
        outcomes: trio(
          { text: 'La résurrection retourne le duel.', deltas: { endurance: 4, renommee: 5, moral: 3 } },
          { text: 'Vous revenez… juste pour tenir.', deltas: { endurance: 2, forme: -4 } },
      ...
      },
      {
        ...
        ifClass: ['Paladin'],
        outcomes: trio(
          { text: 'Chaque riposte sacré le brise un peu plus.', deltas: { endurance: 4, puissance: 3, renommee: 3 } },
          { text: 'Quelques ripostes utiles.', deltas: { endurance: 2 } },
    ...
    options: [
      {
        ...
        outcomes: trio(
          { text: 'Vos coups comptent. On murmure déjà « sauveur ».', deltas: { renommee: 14, puissance: 5, forme: -10, trophies: { cataclysme: 1 } } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'Vous brisez la corruption. L’ancien champion s’incline.', deltas: { renommee: 10, magie: 4, puissance: 3 } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'Vos écailles tiennent le souffle du monde.', deltas: { endurance: 5, magie: 3, renommee: 4 } },
          { text: 'Vous absorbez une part du choc.', deltas: { endurance: 2, forme: -4 } },
    ...
    options: [
      {
        ...
        outcomes: trio(
          { text: 'Grukk tombe. Une arme commune devient votre trophée.', deltas: { or: 8, puissance: 2, renommee: 3, trophies: { donjon: 1 } } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'Sa Lame Empoisonnée devient votre butin.', deltas: { vitesse: 3, or: 10, renommee: 3 } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'Le Dévoreur s’effondre. Un trésor légendaire pulse.', deltas: { puissance: 5, renommee: 8, or: 14, trophies: { donjon: 1 } } },
          { text: 'Vous échappez au Souffle de Flammes… de justesse.', deltas: { endurance: 2, forme: -8, or: 4 } },
      ...
      },
      {
        ...
        ifRace: ['Lycan'],
        outcomes: trio(
          { text: 'Les blessures s’accumulent. La proie s’effondre.', deltas: { puissance: 5, renommee: 4, or: 5 } },
          { text: 'Le saignement aide sans tout décider.', deltas: { puissance: 2 } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'La purge explose. L’antre tremble.', deltas: { puissance: 6, renommee: 4, forme: -5 } },
          { text: 'Douleur utile, résultat moyen.', deltas: { puissance: 2, forme: -6 } },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'Une rumeur vraie sur un boss. Avantage net.', deltas: { magie: 3, vitesse: 2, moral: 2 } },
          { text: 'Des demi-vérités. Toujours ça.', deltas: { magie: 1 } },
      ...
      },
      {
        ...
        ifClass: ['Succube'],
        outcomes: trio(
          { text: 'Un champion accepte de vous entraîner.', deltas: { charisme: 6, renommee: 3, magie: 2 } },
    ...
    options: [
      {
        ...
        outcomes: trio(
          { text: 'Les six tombent. Vos mains tremblent encore.', deltas: { endurance: 5, puissance: 4, forme: -11, renommee: 9, trophies: { bossRush: 1 } } },
          { text: 'Vous tombez au milieu… puis recommencez plus sage.', deltas: { endurance: 2, forme: -8, moral: -2 } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'Trois scalpés. Orgueil intact, gains solides.', deltas: { endurance: 3, or: 6, renommee: 3, forme: -4 } },
          { text: 'Progression honorable.', deltas: { endurance: 1, or: 3, forme: -3 } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'Bleu, Rouge, Violet… vous survivez au territoire.', deltas: { magie: 5, renommee: 6, forme: -6 } },
          { text: 'Vous passez Gojo de justesse.', deltas: { magie: 2, forme: -7 } },
      ...
      },
      {
        ...
        ifRace: ['Humain'],
        outcomes: trio(
          { text: 'Un peu de tout, au bon moment. Victoire nette.', deltas: { puissance: 2, endurance: 2, magie: 2, vitesse: 2, renommee: 3 } },
          { text: 'Polyvalence correcte.', deltas: { puissance: 1, magie: 1 } },
      ...
      },
      {
        ...
        ifClass: ['Alchimiste'],
        outcomes: trio(
          { text: 'Le cycle est parfait. Les bosses fondent.', deltas: { magie: 5, endurance: 2, or: 4, renommee: 3 } },
          { text: 'Flasques utiles, timing moyen.', deltas: { magie: 2 } },
    ...
    options: [
      {
        ...
        outcomes: trio(
          { text: 'Fusion réussie. Votre aura devient unique.', deltas: { magie: 6, renommee: 5, or: 6, trophies: { extension: 1 } } },
          { text: 'Fusion partielle. Potentiel entrevu.', deltas: { magie: 3, forme: -4 } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'Les runes révèlent une faille. Vous en profitez.', deltas: { magie: 4, vitesse: 2, moral: 2 } },
          { text: 'Quelques indices utiles.', deltas: { magie: 1 } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'L’audace paie. Passif rare arraché.', deltas: { renommee: 6, magie: 3, or: 8 } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'L’égide fractale étouffe le territoire.', deltas: { magie: 5, endurance: 3, renommee: 3 } },
          { text: 'Vous affaiblissez quelques runes.', deltas: { magie: 2 } },
      ...
      },
      {
        ...
        ifRace: ['Cendrés'],
        outcomes: trio(
          { text: 'Les braises enflamment votre sort décisif.', deltas: { magie: 6, puissance: 3, forme: -3 } },
          { text: 'Quelques braises, effet correct.', deltas: { magie: 2, forme: -2 } },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'Vous portez sans briller. Votre allié s’en souvient.', deltas: { endurance: 3, magie: 2, or: 5, moral: 3 } },
          { text: 'Soutien honnête.', deltas: { endurance: 1, or: 2 } },
      ...
      },
      {
        ...
        outcomes: trio(
          { text: 'Priorité parfaite. La salle s’ouvre.', deltas: { vitesse: 4, renommee: 3, or: 4 } },
          { text: 'Vous le baissez… un peu tard.', deltas: { vitesse: 1, forme: -3 } },
      ...
      },
      {
        ...
        ifClass: ['Demoniste'],
        outcomes: trio(
          { text: 'Le familier retient les créatures. Vous finissez.', deltas: { magie: 5, renommee: 3, or: 4 } },
          { text: 'Familier utile.', deltas: { magie: 2 } },
          { text: 'Le familier tombe trop vite.', deltas: { magie: -1, moral: -4, forme: -3 } },
        ),
      },
      {
        id: 'gnome',
        ...
        ifRace: ['Gnome', 'Elfe'],
        outcomes: trio(
          { text: 'Vous frappez toujours en premier. L’arène s’incline.', deltas: { vitesse: 6, puissance: 2, renommee: 3 } },
          { text: 'Légère avance de vitesse.', deltas: { vitesse: 2 } },
