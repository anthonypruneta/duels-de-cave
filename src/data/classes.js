...
export const classes = {
  ...
  'Berserk': { ability: 'Rage (CD: 4 tours)', description: 'Consomme 10% de vos PV max (ne peut pas vous tuer). Inflige votre Auto + 25% des PV manquants (après ce coût). Ce pourcentage augmente de +0,1% par point de Cap.', icon: '🪓' }
};
