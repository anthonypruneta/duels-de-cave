...
export const classes = {
  ...
  'Berserk': { ability: 'Rage (CD: 4 tours)', description: 'Consomme 10% de vos PV max (ne peut pas vous tuer). Inflige votre Auto + 35% des PV manquants (après ce coût) + 30% de votre Cap.', icon: '🪓' }
};
