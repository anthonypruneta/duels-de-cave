...
export const classes = {
  ...
  'Demoniste': { ability: 'Attaque du familier (Passif)', description: 'Chaque tour, votre familier inflige 38% de votre Cap et ignore 70% de la RésCap ennemie. Chaque auto augmente ces dégâts de 2% de Cap (cumulable).', icon: '💠' },
