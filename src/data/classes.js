...
export const classes = {
  ...
  'Paladin': { ability: 'Riposte (CD: 2 tours)', description: 'Renvoie 35% des dégâts reçus + 1% de votre Cap.', icon: '🛡️' },
  ...
  'Demoniste': { ability: 'Attaque du familier (Passif)', description: 'Chaque tour, votre familier inflige 70% de votre Cap et ignore totalement la RésCap ennemie. Chaque auto augmente ces dégâts de 3% de Cap (cumulable).', icon: '💠' },
