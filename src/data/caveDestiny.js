...
export const CAVE_DESTINY_AMBITIONS = [
  {
    ...
    icon: '🏆',
    desc: 'Suite Hall → Anciens → Tournoi du samedi. L’ambition s’allume sur la couronne.',
  ...
  },
  {
    ...
    icon: '🏰',
    desc: 'Suites étages → boss (Forêt, Tour, Red, Grotte…). L’ambition s’allume à la finale.',
  ...
  },
  {
    ...
    name: 'Forgé par Ornn',
    icon: '🔨',
    desc: 'Suite upgrade → jugement d’Ornn → lignée légendaire. L’ambition s’allume à la révélation.',
  ...
  },
  {
    ...
    icon: '🪞',
    desc: 'Suites Labyrinthe ou Miroir → Rush → Cataclysme. L’ambition s’allume à la finale.',
