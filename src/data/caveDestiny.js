...
export const CAVE_DESTINY_AMBITIONS = [
  {
    ...
    icon: '🏆',
    desc: 'Vaincre l’arène du tournoi et graver son nom au Hall of Fame. Réussite : ≥ 1 couronne (gros bonus de score).',
  ...
  },
  {
    ...
    icon: '🏰',
    desc: 'Forêt enchantée, Tour du Mage, Grotte aux merveilles, Extension… tout explorer. Réussite : ≥ 2 trophées donjon/tour/extension.',
  ...
  },
  {
    ...
    name: 'Forgé par Ornn',
    icon: '🔨',
    desc: 'Impressionner le Dieu de la Forge et reforger une arme. Réussite : trophée forge ou arme rare/légendaire.',
